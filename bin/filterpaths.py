...
# example usage of this script:  python3 filter_file.py 2025-0a1-01-whateve _posts/2025-01-01-whateve.md assets/img/2025-01-01-whateve/bla.pic assets/html/2025-01-01-whateve/plot1.j assets/bibliography/2025-01-01-whateve.bib assets/img/2025-01-02-whateve/bla.pic
if SUCCESS:
    exit(0)
else:
    exit(1)
